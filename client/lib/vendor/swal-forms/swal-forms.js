;(function () {
    ...
    sweetAlert.withForm = function () {
        // initialize with field values supplied on `sweetAlert.withForm` call
    ...
    extend(SwalForm.prototype, {
        ...
        generateHtmlForm: function () {
            ...
            return t("<div class='{clazz} ui form'>{innerHtml}</div>", form)
        ...
        var input = {
            ...
            toHtml: function () {
                ...
                if (input.type !== 'select') {
                    inputTag = t("<input id='{id}' class='{clazz} swal-form-field ui input' type='{type}' name='{name}'" +
                        " value='{value}' title='{placeholder}' placeholder='{placeholder}'>", input)
                } else {
                    inputTag = t("<select id='{id}' class='{clazz} swal-form-field ui dropdown' name='{name}'" +
                ...
                function toHtmlOptions (optionsString, option) {
                    return optionsString + t("<option value='{value}' {disabled}>{text}</option>", option)
                }
            }
        }
    ...
    sweetAlert.withFormAsync = function (options) {
        return new Promise(function (resolve, reject) {
            sweetAlert.withForm(options, function (isConfirm) {
