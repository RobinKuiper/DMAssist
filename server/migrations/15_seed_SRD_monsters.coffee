Migrations.add
  ...
  up: ->
    ...
    for monster in monsters
      if(oldmonster = MonsterOld.findOne { name: monster.name })
        monster._id = oldmonster._id
        #MonsterOld.remove oldmonster._id

      switch monster.challenge_rating
        when '0' then newCR = 0
        when '1/8' then newCR = 0.125
        when '1/4' then newCR = 0.25
        when '1/2' then newCR = 0.5
        when '1' then newCR = 1
        when '2' then newCR = 2
        when '3' then newCR = 3
        when '4' then newCR = 4
        ...
        when '8' then newCR = 8
        when '9' then newCR = 9
        when '10' then newCR = 10
        when '11' then newCR = 11
        when '12' then newCR = 12
        when '13' then newCR = 13
        when '14' then newCR = 14
        when '15' then newCR = 15
        when '16' then newCR = 16
        when '17' then newCR = 17
        when '18' then newCR = 18
        when '19' then newCR = 19
        when '20' then newCR = 20
        when '21' then newCR = 21
        when '22' then newCR = 22
        when '23' then newCR = 23
        when '24' then newCR = 24
        when '25' then newCR = 25
        when '26' then newCR = 26
        when '27' then newCR = 27
        when '28' then newCR = 28
        when '29' then newCR = 29
        when '30' then newCR = 30

      monster.challenge_rating = newCR

      monster.custom = false
